...
precise token-level content selection, and attention steering mechanisms for long-context inference [ 426,944,
...
context engineering principles. We present four major categories of system implementations. RAGsystems
...
structureswithvectorrepresentationsthroughdual-levelretrievalparadigmsimprovingefficiencyandcontent
...
storage,retrieval,andutilizationmechanisms. Thisimplementationtransformsmodelsfrompattern-matching
processors into sophisticated agents capable of learning, adaptation, and long-term contextual understanding
across extended interactions.
Memory Systems
Memory-Enhanced AgentsEvaluation and Challenges
...
External Memory
Hierarchical Memory
Figure5: Memory Systems Framework: Overview of memory architectures, memory-enhanced agents, and
...
Implementation-basedclassificationsidentifyparametricmemory(knowledgeencodedinmodelweights),
...
mechanismsanalogoustohumanassociativememory[ 518,325,326,764,464]. Theseclassificationschemes
...
information lists [ 477]. Memory retrieval operates through sequential access (retrieving content in consecu-
...
Memoryorganizationencompassesdiversestructuralapproachesincludingtextual-formstorage(complete
...
AgentArchitectureIntegration ContemporaryLLMagentsemploymemorysystemsanalogoustocomputer
...
ModelTextual Form Parametric Form
...
requiringgoal-orientedconversationsteeringthroughprompt-basedpolicyplanningmethodsandAIfeedback
...
widespreadadoptionofmemorysystemsforenhancedpersonalizationcapabilities[ 1167]. Tool-augmentation
...
significantobstacle, withexistingframeworksoftenfailingtocapturethefullspectrumofmemorycapabilities
...
Function Calling MechanismsTool-Integrated Reasoning
Environment Interaction
From "Text Generator" to "World Interactor"External Tools
Dynamic
Data
Search
Engine
...
Calculation 
Engine
Figure6: Tool-Augmented Systems Framework: Evolution from text generators to world interactors through
...
Program-AidedLanguageModels(PAL)pioneeredproblemdecompositionstrategiesbygeneratingexecutable
...
reasoningbyintegratingnaturallanguageprocessingwithcomputationallibrariesandsymbolicsolvers,while
...
actions interface with external information sources [1245]. Chameleon introduced plug-and-play composi-
...
MethodTool Categories
Search &
RetrievalComputation &
Code ExecutionKnowledge Base
& QAAPIs &
External ServicesMultimodal
ToolsLanguage
ProcessingInteractive
EnvironmentsDomain-Specific
Tools
ReAct [1247] ✓ ✓ ✓
Toolformer [931] ✓ ✓ ✓ ✓ ✓
ToolkenGPT [378] ✓ ✓ ✓ ✓ ✓
...
less than 50
Functioncallingenabledsophisticatedmulti-agentsystemswheremultipleLLMagentscollaboratethrough
...
Multi-Agent Systems
Orchestration MechanismsCommunication Protocols Coordination Strategies
Connection and Collaboration
Figure7:Multi-AgentSystemsFramework: Overviewofcommunicationprotocols, orchestrationmechanisms,
...
lengeshinderingLLMagentcollaboration[ 1235,1128,408]. MCPfunctionsas“USB-CforAI,”standardizing
...
ANPextendsinteroperabilitytoopeninternetthroughW3CdecentralizedidentifiersandJSON-LDgraphs,
...
LLM-EnhancedCommunicationFrameworks LLMstransformagentcommunicationthroughsophisticated
...
orchestratorsarrangecomponentsinlogicalsequencesbasedonuserinstructions,utilizingLLMsascomponent
...
ContextManagementandEnvironmentalAdaptation Contextservesasthefoundationalelementguiding
...
tialfailures, andvalidationlimitationsemergeasmanyframeworksrelyexclusivelyonlargelanguagemodels’
...
agents based on clinical query type, user background, and data modality requirements [ 613,754,1051];
...
Thissubsectionpresentscomprehensiveapproachesforevaluatingbothindividualcomponentsandintegrated
...
Forprompt engineering components, evaluation encompasses prompt effectiveness measurement
...
GPT-4achievingapproximately20%improvementthroughiterativeself-refinementprocesses[ 735,956,789].
...
izedassessmentframeworksandtheinherentlystatelesscharacteristicsofcontemporaryLLMs. LongMemEval
...
specializedmodulesforretrieval,augmentation,andgeneration,enablingfine-grainedevaluationofindividual
...
WebagentevaluationframeworksincludingWebArenaandMind2Webprovidecomprehensiveassessment
...
challengesincoordinationfailurescenarios,wherepartialsystemfailurescancascadethroughtheentireagent
...
acrossmultiplecomponents. Long-termevaluationmustassesswhethersystemsmaintainbeneficialbehaviors
...
capabilities,andapplicationsemerge. Futureevaluationparadigmsmustaddressincreasingsystemcomplexity
...
techniquesandprovideprincipleddesignguidelines, representingacriticalresearchgapthatlimitssystematic
...
coherence,factualconsistencymaintenance,andplanningsophistication,requiringinvestigationintowhether
...
Beyondthesesensorymodalities, contextengineeringmustalsohandlemoreabstractformsofinformation
...
strategies,whileothersexploreconvertinggraphsintonaturallanguagedescriptionstofacilitatemodelunder-
...
execution [1368, 202].
Cross-modalalignmentandconsistencypresentongoingchallengesinensuringthatinformationextracted
...
incorporatingDPOtoenhancereasoningreliability,achieving65%averageaccuracyacrossdiversegraphtasks
...
Self-refinementmechanismsdemonstratesubstantialpotentialforintelligentcontextoptimizationthrough
...
Multi-dimensionalfeedbackmechanismsincorporatingdiversefeedbackdimensionsincludingcorrectness,
...
Scientificresearchapplicationsrequiresophisticatedreasoningcapabilitiesovercomplextechnicalcontent,
...
Orchestrationchallengesincludingtransactionalintegrity,contextmanagement,andcoordinationstrategy
effectivenessrepresentsignificantobstaclestolarge-scalemulti-agentdeployment. Contemporaryframeworks
...
Privacyprotectionmechanismsmustaddresschallengesinhandlingsensitiveinformation,preventingdata
...
ThefutureofContextEngineeringwillbeshapedbyourabilitytoaddresstheseinterconnectedchallenges
...
Context Engineering.
References
[1]Anp-agent communication meta-protocol specification(draft). https://
agent-network-protocol.com/specs/communication.html . [Online; accessed 17-
July-2025].
...
mizingaretrievalaugmentedgenerationusinglargelanguagemodelonacademicdata. International
...
[37]Anthropic. Introducing the model context protocol, November 2024. URL https://www.
...
Vision, 2023.
[53]JayachanduBandlamudi,K.Mukherjee,PrernaAgarwal,SampathDechu,SiyuHuo,VatcheIsahagian,
Vinod Muthusamy, N. Purushothaman, and Renuka Sindhgatta. Towards hybrid automation by
bootstrappingconversationalinterfacesforitoperationtasks. AAAIConferenceonArtificialIntelligence ,
2023.
...
[58]KinjalBasu, IbrahimAbdelaziz, KelseyBradford, M.Crouse,KiranKate, SadhanaKumaravel, Saurabh
Goyal,AsimMunawar,YaraRizk,XinWang,LuisA.Lastras,andP.Kapanipathi. Nestful: Abenchmark
...
[67]GauravBeriandVaishnaviSrivastava. Advancedtechniquesinpromptengineeringforlargelanguage
...
AureliaGuy, JacobMenick, RomanRing, T.Hennigan, SaffronHuang, LorenzoMaggiore, ChrisJones,
...
Language Processing , 2022.
[87]FutureSearchNikosI.Bosse,JonEvans,RobertG.Gambee,DanielHnyk,PeterMuhlbacher,Lawrence
...
[111]YujunCai,LinHuang,YiweiWang,Tat-JenCham,JianfeiCai,JunsongYuan,JunLiu,XuYang,Yiheng
Zhu, Xiaohui Shen, et al. Learning progressive joint propagation for human motion prediction.
InComputer Vision–ECCV 2020: 16th European Conference, Glasgow, UK, August 23–28, 2020,
...
Neuroscience , 2014.
[114]BoxiCao, QiaoyuTang, HongyuLin, XianpeiHan, JiaweiChen, TianshuWang, andLeSun. Retentive
...
KangLiu,andJunZhao. Largelanguagemodelsforplanning: Acomprehensiveandsystematicsurvey,
...
and Technology , 2023.
[130]SubhajitChaudhury, PayelDas, SarathkrishnaSwaminathan, GeorgiosKollias, ElliotNelson, Khushbu
...
[138]JianingChen, ZehaoLi, YujunCai, HaoJiang, ChengxuanQian, JuyuanKang, ShuqinGao, Honglong
...
[143]JustinChih-YaoChen,ArchikiPrasad,SwarnadeepSaha,EliasStengel-Eskin,andMohitBansal. Magi-
core: Multi-agent,iterative,coarse-to-finerefinementforreasoning,arXivpreprintarXiv:2409.12147,
...
[149]S Chen, Y Wang, YF Wu, and Q Chen.... Advancing tool-augmented large
...
[155]Yixin Chen, Shuai Zhang, Boran Han, Tong He, and Bo Li. Camml: Context-aware multimodal
...
[162]Mingyue Cheng, Yucong Luo, Ouyang Jie, Qi Liu, Huijie Liu, Li Li, Shuo Yu, Bohou Zhang, JiaweiCao,
...
[165]Xin Cheng, Di Luo, Xiuying Chen, Lemao Liu, Dongyan Zhao, and Rui Yan. Lift yourself up:
...
[168]EgorCherepanov,NikitaKachaev,A.Kovalev,andAleksandrI.Panov. Memory,benchmark&robots: A
...
URLhttps://arxiv.org/abs/2504.19413 .
...
URLhttps://arxiv.org/abs/2505.19253v2 .
[179]Emile Contal and Garrin McGoldrick. Ragsys: Item-cold-start recommender as rag system. IR-
RAG@SIGIR , 2024.
[180]Erica Coppolillo. Injecting knowledge graphs into large language models, arXiv preprint
arXiv:2505.07554, 2025. URL https://arxiv.org/abs/2505.07554v1 .
72

[181]R. P. Costa, R. Froemke, P. J. Sjöström, and Mark C. W. van Rossum. Unified pre- and postsynaptic
...
[195]TriDao. Flashattention-2: Fasterattentionwithbetterparallelismandworkpartitioning. International
...
[210]Darshan Deshpande, Varun Gangal, Hersh Mehta, Jitin Krishnan, Anand Kannappan, and Rebecca
Qian. Trail: Trace reasoning and agentic issue localization, arXiv preprint arXiv:2505.08638, 2025.
URLhttps://arxiv.org/abs/2505.08638v3 .
...
QiZhang,andXuanjingHuang. Mitigatingtailnarrowinginllmself-improvementviasocratic-guided
...
[223]Guanting Dong, Yifei Chen, Xiaoxi Li, Jiajie Jin, Hongjin Qian, Yutao Zhu, Hangyu Mao, Guorui
...
URLhttps://arxiv.org/abs/2505.14309v1 .
[231]MohammadrezaDoostmohammadian, AlirezaAghasi, MohammadPirani, EhsanNekouei, H.Zarrabi,
...
[236]Jingfei Du, Edouard Grave, Beliz Gunel, Vishrav Chaudhary, Onur Çelebi, Michael Auli, Ves Stoyanov,
...
[245]Candace Edwards. Hybrid context retrieval augmented generation pipeline: Llm-augmented
...
[248]Lutfi Eren Erdogan, Nicholas Lee, Siddharth Jha, Sehoon Kim, Ryan Tabrizi, Suhong Moon, Coleman
...
[257]Junfeng Fang, Zijun Yao, Ruipeng Wang, Haokai Ma, Xiang Wang, and Tat-Seng Chua. We
...
[262]Bahare Fatemi, Jonathan J. Halcrow, and Bryan Perozzi. Talk like a graph: Encoding graphs for large
...
replay, arXivpreprintarXiv:2505.17716, 2025. URL https://arxiv.org/abs/2505.17716v1 .
...
12599v1 .
[273]YanlinFeng, XinyueChen, BillYuchenLin, PeifengWang, JunYan, andXiangRen. Scalablemulti-hop
...
[276]Tharindu Fernando, Simon Denman, A. Mcfadyen, S. Sridharan, and C. Fookes. Tree memory
...
[284]MeireFortunato,MelissaTan,RyanFaulkner,S.Hansen,AdriàPuigdomènechBadia,GavinButtimore,
...
[290]Chaoyou Fu, Yuhan Dai, Yondong Luo, Lei Li, Shuhuai Ren, Renrui Zhang, Zihan Wang, Chenyu
...
URLhttps://arxiv.org/abs/2108.07839v2 .
...
[305]Luyu Gao, Aman Madaan, Shuyan Zhou, Uri Alon, Pengfei Liu, Yiming Yang, Jamie Callan, and
...
URLhttps://arxiv.org/abs/2503.08549v1 .
...
[311]YunfanGao,YunXiong,XinyuGao,KangxiangJia,JinliuPan,YuxiBi,YiDai,JiaweiSun,QianyuGuo,
...
[320]Yuyao Ge, Shenghua Liu, Yiwei Wang, Lingrui Mei, Lizhe Chen, Baolong Bi, and Xueqi Cheng. Innate
...
[333]In Gim, Seung seob Lee, and Lin Zhong. Asynchronous llm function calling, arXiv preprint
...
[349]Yongli Gu, Xiang Yan, Hanlin Qin, Naveed Akhtar, Shuai Yuan, Honghao Fu, Shuowen Yang, and
...
URLhttps://arxiv.org/abs/2503.22458v1 .
...
URLhttps://arxiv.org/abs/2406.13250v1 .
...
FangShi, FelixBai, FrankChu, FredHohman, HadasKotek, HannahGillisColeman, JaneLi, JeffreyP.
...
[356]Taicheng Guo, Xiuying Chen, Yaqi Wang, Ruidi Chang, Shichao Pei, N. Chawla, Olaf Wiest, and
...
datasetforevaluatingnestedtoollearningabilitiesoflargelanguagemodels. InternationalConference
...
URLhttps://arxiv.org/abs/2506.00069v1 .
...
[381]A. Hassani, A. Medvedev, P. D. Haghighi, Sea Ling, A. Zaslavsky, and P. Jayaraman. Context definition
...
[387]Shawn He, Surangika Ranathunga, Stephen Cranefield, and B. Savarimuthu. Norm violation
...
[395]Shekoofeh Hedayati, Ryan E. O’Donnell, and Brad Wyble. A model of working memory for latent
...
[410]Wenyi Hong, Weihan Wang, Qingsong Lv, Jiazheng Xu, Wenmeng Yu, Junhui Ji, Yan Wang, Zihan
...
URLhttps://arxiv.org/abs/2411.10937v1 .
...
[424]J. E. Hu, Yelong Shen, Phillip Wallis, Zeyuan Allen-Zhu, Yuanzhi Li, Shean Wang, and Weizhu
...
[430]Nathan J. Hu, E. Mitchell, Christopher D. Manning, and Chelsea Finn. Meta-learning online
...
[437]Brandon Huang, Chancharik Mitra, Assaf Arbelle, Leonid Karlinsky, Trevor Darrell, and Roei Herzig.
...
URLhttps://arxiv.org/abs/2408.12188v1 .
...
[449]Wenlong Huang, P. Abbeel, Deepak Pathak, and Igor Mordatch. Language models as zero-shot
...
Integratinglargelanguagemodelsforinteractiverecommendations,arXivpreprintarXiv:2308.16505,
...
[459]EunjeongHwang, YichaoZhou, JamesBradleyWendt, BelizGunel, NguyenVo, JingXie, andSandeep
Tata. Enhancingincrementalsummarizationwithstructuredrepresentations. ConferenceonEmpirical
...
[463]T Inaba, H Kiyomaru, F Cheng, and S Kurohashi. Multitool-cot: Gpt-3 can use multiple external
tools with chain of thought prompting. 2023. URL https://arxiv.org/abs/2305.16896 .
[464]G. Indiveri and Shih-Chii Liu. Memory and information processing in neuromorphic systems.
...
[479]T. S. Jayram, Younes Bouhadjar, Ryan L. McAvoy, Tomasz Kornuta, Alexis Asseman, K. Rocki, and
...
YizhouSun,JinchaoLi,QifanWang,andAsliCelikyilmaz. Resprompt: Residualconnectionprompting
...
[492]Zhonglin Jiang, Qian Tang, and Zequn Wang. Generative reliability-based design optimization using
in-context learning capabilities of large language models, arXiv preprint arXiv:2503.22401, 2025.
URLhttps://arxiv.org/abs/2503.22401v1 .
...
[496]Bowen Jin, Yu Zhang, Qi Zhu, and Jiawei Han. Heterformer: Transformer-based deep node
...
[502]TianJin, W.Yazar, ZifeiXu, SayehSharify, andXinWang. Self-selectedattentionspanforaccelerating
...
language-visionpretraininginllmwithdynamicdiscretevisualtokenization. InternationalConference
on Learning Representations , 2023.
96

[505]Yiqiao Jin, Minje Choi, Gaurav Verma, Jindong Wang, and Srijan Kumar. Mm-soc: Benchmarking
...
[508]JeffA.JohnsonandDanielH.Bullock. Fragilityinaisusingartificialneuralnetworks. Communications
of the ACM , 2023.
...
abs/2504.02891v1 .
[511]A.Kakas,P.Mancarella,F.Sadri,KostasStathis,andFrancescaToni. Computationallogicfoundations
...
URLhttps://arxiv.org/abs/2502.06049v1 .
...
[520]Zdeněk Kasner and Ondrej Dusek. Beyond traditional benchmarks: Analyzing behaviors of open llms
...
Maschinot, CeLiu, andDilipKrishnan. Supervisedcontrastivelearning. NeuralInformationProcessing
Systems, 2020.
...
[534]Sambhav Khurana, Xiner Li, Shurui Gui, and Shuiwang Ji. A hierarchical language model for
...
[547]Andrew Kiruluta, Preethi Raju, and Priscilla Burity. Breaking quadratic barriers: A non-attention
...
[551]Jing Yu Koh, R. Salakhutdinov, and Daniel Fried. Grounding language models to images for
...
[565]RajeevKumar, HarishankarKumar, andKumariShalini. Detectingandmitigatingbiasinllmsthrough
...
[573]B. Lattimer, Varun Gangal, Ryan McDonald, and Yi Yang. Sparse rewards can self-train dia-
logue agents, arXiv preprint arXiv:2409.04617, 2024. URL https://arxiv.org/abs/2409.
04617v2 .
[574]Pak Kin Lau and Stuart Michael McManus. Mining asymmetric intertextuality, arXiv preprint
...
[576]Dohyun Lee, Seungil Chad Lee, Chanwoo Yang, Yujin Baek, and Jaegul Choo. Exploring in-context
...
ComputationalLinguistics: ACL2023 .AssociationforComputationalLinguistics,2023. doi: 10.18653/
...
[582]JonathanLee, AnnieXie, AldoPacchiano, YashChandak, ChelseaFinn, OfirNachum, andE.Brunskill.
...
URLhttps://arxiv.org/abs/2505.11924v1 .
102

[588]Melissa Lehman and Kenneth J. Malmberg. A buffer model of memory encoding and temporal
...
Wang, XiangWang, JunyangLin, andDayihengLiu. Cort: Code-integratedreasoningwithinthinking,
...
[596]ChuanhaoLi,RunhanYang,TiankaiLi,MiladBafarassat,KouroshSharifi,DirkBergemann,andZhuo-
...
[601]Guozheng Li, Peng Wang, Jiajun Liu, Yikai Guo, Ke Ji, Ziyu Shang, and Zijie Xu. Meta in-context
...
digitalactionsinresponsetoreal-worldmultimodalsensoryinputswithllms. InternationalConference
...
URLhttps://arxiv.org/abs/2305.06355v2 .
...
[614]Ming Li, Keyu Chen, Ziqian Bi, Ming Liu, Benji Peng, Qian Niu, Junyu Liu, Jinlang Wang, Sen
...
[626]Xinze Li, Zhenghao Liu, Chenyan Xiong, Shi Yu, Yu Gu, Zhiyuan Liu, and Ge Yu. Structure-aware
...
[630]Yucheng Li. Unlocking context constraints of llms: Enhancing context efficiency of llms with
...
[639]Zhong-Zhi Li, Ming-Liang Zhang, Fei Yin, Zhi-Long Ji, Jin-Feng Bai, Zhen-Ru Pan, Fan-Hu Zeng,
...
Han, LeSun, andYongbinLi. Structrag: Boostingknowledgeintensivereasoningofllmsviainference-
...
URLhttps://arxiv.org/abs/2409.00872v2 .
...
self-improvement,arXivpreprintarXiv:2503.19271,2025. URL https://arxiv.org/abs/2503.
19271v2 .
107

[652]Yanbiao Liang, Huihong Shi, Haikuo Shao, and Zhongfeng Wang. Accllm: Accelerating long-context
...
[657]DavidLillis. Internalisinginteractionprotocolsasfirst-classprogrammingelementsinmultiagentsys-
tems, arXiv preprint arXiv:1711.02634, 2017. URL https://arxiv.org/abs/1711.02634v1 .
[658]BillYuchenLin,XinyueChen,JaminChen,andXiangRen. Kagnet: Knowledge-awaregraphnetworks
...
Linguistics , 2023.
[663]MatthieuLin,JennySheng,AndrewZhao,ShenzhiWang,YangYue,YiranWu,HuanLiu,JunLiu,Gao
Huang,andYong-JinLiu. Trainingofscaffoldedlanguagemodelswithlanguagesupervision: Asurvey,
...
[665]Yu-Chen Lin, Akhilesh Kumar, Norman Chang, Wen-Liang Zhang, Muhammad Zakir, Rucha Apte,
...
[674]GuangyiLiu, PengxiangZhao, LiangLiu, YaxuanGuo, HanXiao, WeifengLin, YuxiangChai, YueHan,
ShuaiRen,HaoWang,XiaoyuLiang,WenhaoWang,TianzeWu,LinghaoLi,GuanjingXiong,YongLiu,
...
[678]Jie Liu, Pan Zhou, Yingjun Du, Ah-Hwee Tan, Cees G. M. Snoek, J. Sonke, and E. Gavves. Capo: Co-
...
[684]NaLiu,LiangyuChen,XiaoyuTian,WeiZou,KaijiangChen,andMingCui. Fromllmtoconversational
...
[691]Weiwen Liu, Xu Huang, Xingshan Zeng, Xinlong Hao, Shuai Yu, Dexun Li, Shuai Wang, Weinan Gan,
Zhengying Liu, Yuanqing Yu, Zezhong Wang, Yuxian Wang, Wu Ning, Yutai Hou, Bin Wang, Chuhan
Wu, XinzhiWang, YongLiu, YashengWang, DuyuTang, DandanTu, LifengShang, XinJiang, Ruiming
...
[698]ZijunLiu, YanzheZhang, PengLi, YangLiu, andDiyiYang. Adynamicllm-poweredagentnetworkfor
...
[703]Joseph R. Loffredo and Suyeol Yun. Agent-enhanced large language models for researching political
...
[712]YinquanLu, H.Lu, GuirongFu, andQunLiu. Kelm: Knowledgeenhancedpre-trainedlanguagerepre-
...
[716]Haitong Luo, Xuying Meng, Suhang Wang, Tianxiang Zhao, Fali Wang, Hanyun Cao, and Yujun
...
[725]YougangLyu, XiaoyuZhang, LingyongYan, M.D.Rijke, ZhaochunRen, andXiuyingChen. Deepshop:
A benchmark for deep research shopping agents, arXiv preprint arXiv:2506.02839, 2025. URL
https://arxiv.org/abs/2506.02839v1 .
[726]JianxiangMa. Researchontheroleofllminmulti-agentsystems: Asurvey. AppliedandComputational
Engineering , 2024.
...
[728]Qun Ma, Xiao Xue, Deyu Zhou, Xiangning Yu, Donghua Liu, Xuwen Zhang, Zihan Zhao, Yifan
...
URLhttps://arxiv.org/abs/2402.00262v1 .
...
[733]Zhiyuan Ma, Zhenya Huang, JiayuLiu, Minmao Wang, HongkeZhao, andXinLi. Automatedcreation
...
NouhaDziri,ShrimaiPrabhumoye,YimingYang,S.Welleck,BodhisattwaPrasadMajumder,Shashank
...
[741]Qiheng Mao, Zemin Liu, Chenghao Liu, Zhuo Li, and Jianling Sun. Advancing graph representa-
...
URLhttps://arxiv.org/abs/2505.24478v1 .
...
16971v4 .
[758]Lingrui Mei, Shenghua Liu, Yiwei Wang, Baolong Bi, and Xueqi Cheng. Slang: New concept
...
Fine-grainedsafegenerationwithspecializedrepresentationrouter, arXivpreprintarXiv:2410.02684,
...
[764]KevinMeng,DavidBau,A.Andonian,andYonatanBelinkov. Locatingandeditingfactualassociations
...
[768]Thomas Merth, Qichen Fu, Mohammad Rastegari, and Mahyar Najibi. Superposition prompting:
...
[782]Fedor Moiseev, Zhe Dong, Enrique Alfonseca, and Martin Jaggi. Skill: Structured knowledge infusion
for large language models. North American Chapter of the Association for Computational Linguistics ,
2022.
[783]Dimitri Coelho Mollo and Raphael Milliere. The vector grounding problem, arXiv preprint
...
URLhttps://arxiv.org/abs/2502.20122v3 .
...
[796]Koichi Namekata, Amirmojtaba Sabour, Sanja Fidler, and Seung Wook Kim. Emerdiff: Emerging
...
2505.06328v1 .
[807]OpenAI. Computer-using agent, 2025. URL https://openai.com/index/
...
[811]Gustavo Ortiz-Hernández, Alejandro Guerra-Hernández, J. Hübner, and W. A. Luna-Ramírez. Mod-
...
URLhttps://arxiv.org/abs/2310.08560 .
...
[816]QianjunPan,WenkaiJi,YuyangDing,JunsongLi,ShilianChen,JunyiWang,JieZhou,QinChen,Min
...
21239v1 .
[819]BoPang,HanzeDong,JiachengXu,SilvioSavarese,YingboZhou,andCaimingXiong. Bolt: Bootstrap
...
[825]J. Park, Joseph C. O’Brien, Carrie J. Cai, M. Morris, Percy Liang, and Michael S. Bernstein. Generative
...
[838]F. Petroni, Patrick Lewis, Aleksandra Piktus, Tim Rocktäschel, Yuxiang Wu, Alexander H. Miller, and
...
[851]S.Qasim,HassanMahmood,andF.Shafait. Rethinkingtablerecognitionusinggraphneuralnetworks.
...
URLhttps://arxiv.org/abs/2411.02337v3 .
...
[863]S Qiao, H Gui, C Lv, Q Jia, H Chen, and N Zhang. Making language models better tool learners with
...
[867]YujiaQin, ShiLiang, YiningYe, KunlunZhu, LanYan, Ya-TingLu, YankaiLin, XinCong, XiangruTang,
...
[870]ZhenQin, WeigaoSun, DongLi, XuyangShen, WeixuanSun, andYiranZhong. Lightningattention-2:
...
URLhttps://arxiv.org/abs/2505.20246v3 .
...
Learning , 2021.
[882]ColinRaffel, NoamM.Shazeer, AdamRoberts, KatherineLee, SharanNarang, MichaelMatena, Yanqi
...
developpromptingproficiencyinarchitecturalai-generatedimages, arXivpreprintarXiv:2504.13948,
2025. URL https://arxiv.org/abs/2504.13948v2 .
126

[899]Albert Roethel, M. Ganzha, and Anna Wr’oblewska. Enriching language models with graph-based
...
American Chapter of the Association for Computational Linguistics , 2025.
[903]J.RosserandJakobN.Foerster. Agentbreeder: Mitigatingtheaisafetyimpactofmulti-agentscaffolds,
...
URLhttps://arxiv.org/abs/1803.05464v1 .
...
DanDebrunner,andSameepMehta. Sequentialapifunctioncallingusinggraphqlschema. Conference
...
Computation , 2025.
[925]Ranjan Sapkota, Konstantinos I. Roumeliotis, and Manoj Karkee. Ai agents vs. agentic ai: A
...
[927]Soumajyoti Sarkar and Leonard Lausen. Testing the limits of unified sequence to sequence llm
...
[934]SheilaSchoepp,MasoudJafaripour,YingyueCao,TianpeiYang,FatemehAbdollahi,ShadanGolestan,
...
[935]Lianlei Shan, Shixian Luo, Zezhou Zhu, Yu Yuan, and Yong Wu. Cognitive memory in large
...
[937]YunfanShao,LinyangLi,JunqiDai,andXipengQiu. Character-llm: Atrainableagentforrole-playing,
...
[940]Peter Shaw, Mandar Joshi, James Cohan, Jonathan Berant, Panupong Pasupat, Hexiang Hu, Urvashi
...
BeidiChen,ClarkW.Barrett,JosephGonzalez,PercyLiang,ChristopherRé,IonStoica,andCeZhang.
...
[952]Zhengliang Shi, Shen Gao, Xiuyi Chen, Yue Feng, Lingyong Yan, Haibo Shi, Dawei Yin, Zhumin
...
[961]AltunShukurlu. Improvingdeepknowledgetracingviagatedarchitecturesandadaptiveoptimization,
...
[965]JoykiratSingh,RaghavMagazine,YashPandya,andA.Nambi. Agenticreasoningandtoolintegration
...
[978]Woomin Song, Sai Muralidhar Jayanthi, S. Ronanki, Kanthashree Mysore Sathyendra, Jinwoo Shin,
...
[992]Weihang Su, Yichen Tang, Qingyao Ai, Zhijing Wu, and Yiqun Liu. Dragin: Dynamic retrieval
...
Currentandfuturedirections, arXivpreprintarXiv:2405.11106, 2024. URL https://arxiv.org/
abs/2405.11106v1 .
...
[1001] LeiSun,ZhengweiTao,YoudiLi,andHiroshiArakawa. Oda: Observation-drivenagentforintegrating
...
[1004] Lijun Sun, Yijun Yang, Qiqi Duan, Yuhui Shi, Chao Lyu, Yu-Cheng Chang, Chin-Teng Lin, and
...
Intelligence , 2019.
[1007] Rao Surapaneni, Miku Jha, Michael Vakoc, and Todd Segal. Announcing the
agent2agent protocol (a2a). https://developers.googleblog.com/en/
a2a-a-new-era-of-agent-interoperability/ , April 2025. [Online; accessed 17-
July-2025].
...
[1014] K.Tallam. Fromautonomousagentstointegratedsystems, anewparadigm: Orchestrateddistributed
...
[1018] Xiaoyu Tan, Haoyu Wang, Xihe Qiu, Yuan Cheng, Yinghui Xu, Wei Chu, and Yuan Qi. Struct-x:
...
[1020] Zhijie Tan, Xu Chu, Weiping Li, and Tong Mo. Order matters: Exploring order sensitivity in
...
Graphgpt: Graphinstructiontuningforlargelanguagemodels. In Proceedingsofthe47thInternational
...
[1028] XuemeiTang,JunWang,andQ.Su. Chinesewordsegmentationwithheterogeneousgraphneuralnet-
...
[1032] Yao Tao, Yehui Tang, Yun Wang, Mingjian Zhu, Hailin Hu, and Yunhe Wang. Saliency-driven
dynamic token pruning for large language models, arXiv preprint arXiv:2504.04514, 2025. URL
https://arxiv.org/abs/2504.04514v2 .
[1033] DenisTarasovandKumarShridhar. Distillingllms’decompositionabilitiesintocompactlanguagemod-
...
URLhttps://36kr.com/p/3337269379328264 . Chinese business and technology media pub-
...
[1044] FernandaMDeLaTorre, CathyMengyingFang, HanHuang, AndrzejBanburski-Fahey, JudithAmores
...
AshishSabharwal,andNiranjanBalasubramanian. Appworld: Acontrollableworldofappsandpeople
...
[1056] Saeid Ario Vaghefi, Aymane Hachcham, Veronica Grasso, Jiska Manicus, Nakiete Msemo, C. Senni,
...
[1067] TomVölker,JanPfister,TobiasKoopmann,andAndreasHotho. Fromchattopublicationmanagement:
Organizing your related work using bibsonomy & llms. Conference on Human Information Interaction
and Retrieval , 2024.
[1068] D. Walton. Using argumentation schemestofind motives andintentionsof arational agent. Argument
Comput. , 2020.
...
[1070] Jun Wan and Lingrui Mei. Large language models as computable approximations to solomonoff in-
...
13356v1 .
[1072] Bernie Wang, Si ting Xu, K. Keutzer, Yang Gao, and Bichen Wu. Improving context-based
...
[1081] Hanrui Wang, Zhekai Zhang, and Song Han. Spatten: Efficient sparse attention architecture
...
[1083] Haochun Wang, Chi Liu, Nuwa Xi, Zewen Qiang, Sendong Zhao, Bing Qin, and Ting Liu. Huatuo:
...
Linguistics , 2024.
[1087] HongruWang, ChengQian, ManlingLi, JiahaoQiu, BoyangXue, MengdiWang, HengJi, andKam-Fai
...
[1089] JingyuWang, LuZhang, XueqingLi, HuazhongYang, andYongpanLiu. Ulseq-ta: Ultra-longsequence
...
URLhttps://arxiv.org/abs/2505.19339v1 .
...
[1096] Liyuan Wang, Bo Lei, Qian Li, Hang Su, Jun Zhu, and Yi Zhong. Triple-memory networks: A
...
Revolutionizinggraphreasoninginllmsthroughdecomposedsubtaskinstruction. KnowledgeDiscovery
and Data Mining , 2024.
...
[1108] Xiaohan Wang, Yuhui Zhang, Orr Zohar, and S. Yeung-Levy. Videoagent: Long-form video under-
...
International Joint Conference on Artificial Intelligence , 2024.
[1113] XingyaoWang, Yangyi Chen, Lifan Yuan, YizheZhang, YunzhuLi, Hao Peng, and HengJi. Executable
...
[1121] Yingming Wang and Pepa Atanasova. Self-critique and refinement for faithful natural language
...
[1133] Ziyang Wang, Jianzhou You, Haining Wang, Tianwei Yuan, Shichao Lv, Yang Wang, and Limin Sun.
...
[1147] Genta Indra Winata, Lingjue Xie, Karthik Radhakrishnan, Shijie Wu, Xisen Jin, Pengxiang Cheng,
...
URLhttps://arxiv.org/abs/2411.02006v2 .
...
[1159] Ruofan Wu, Youngwon Lee, Fan Shu, Danmei Xu, Seung won Hwang, Zhewei Yao, Yuxiong He,
...
[1165] XinboWuandL.Varshney. Ameta-learningperspectiveontransformersforcausallanguagemodeling.
Annual Meeting of the Association for Computational Linguistics , 2023.
...
[1171] Menglin Xia, Victor Ruehle, Saravan Rajmohan, and Reza Shokri. Minerva: A programmable
...
JinsongSu. Whentousegraphsinrag: Acomprehensiveanalysisforgraphretrieval-augmentedgener-
...
[1178] YangXiao,JiashuoWang,RuifengYuan,ChunpuXu,KaishuaiXu,WenjieLi,andPengfeiLiu. Limopro:
...
[1182] YueXing,TaoYang,YijiashunQi,MingguWei,YuCheng,andHonghuiXin. Structuredmemorymech-
...
[1183] GuangzhiXiong,QiaoJin,XiaoWang,YinFang,HaolinLiu,YifanYang,FangyuanChen,ZhixingSong,
...
2407.08516v5 .
[1185] JunjieXiong, ChangjiaZhu, ShuhangLin, ChongZhang, YongfengZhang, YaoLiu, andLingyaoLi. In-
...
URLhttps://arxiv.org/abs/2412.04141v3 .
...
[1196] Minrui Xu, D. Niyato, and Christopher G. Brinton. Serving long-context llms at the mobile edge:
...
[1223] Lin F. Yang, Hongyang Chen, Zhao Li, Xiao Ding, and Xindong Wu. Give us the facts: Enhancing
...
14866v2 .
[1228] ShanglongYang,ZhipengYuan,ShunbaoLi,RuolingPeng,KangLiu,andPoYang. Gpt-4asevaluator:
...
URLhttps://arxiv.org/abs/2403.20208v7 .
...
[1236] Yuan Yang, Siheng Xiong, Ehsan Shareghi, and F. Fekri. The compressor-retriever architecture for
...
[1249] Weiran Yao, Shelby Heinecke, Juan Carlos Niebles, Zhiwei Liu, Yihao Feng, Le Xue, Rithesh Murthy,
...
[1250] MichihiroYasunaga, HongyuRen, AntoineBosselut, PercyLiang, andJ.Leskovec. Qa-gnn: Reasoning
...
Liang,andJ.Leskovec. Deepbidirectionallanguage-knowledgegraphpretraining. NeuralInformation
Processing Systems , 2022.
...
URLhttps://arxiv.org/abs/2503.16416v1 .
...
[1262] Fan Yin, Zifeng Wang, I-Hung Hsu, Jun Yan, Ke Jiang, Yanfei Chen, Jindong Gu, Long T. Le,
...
[1288] E. Zelikman, Eliana Lorch, Lester Mackey, and A. Kalai. Self-taught optimizer (stop): Recursively
...
[1296] Chaoyun Zhang, He Huang, Chiming Ni, JianMu, SiQin, ShilinHe, Lu Wang, FangkaiYang, PuZhao,
...
[1301] Duzhen Zhang, Yahan Yu, Jiahua Dong, Chenxing Li, Dan Su, Chenhui Chu, and Dong Yu. Mm-
...
memoryinjection,arXivpreprintarXiv:2404.03565,2025. URL https://arxiv.org/abs/2404.
03565.
[1309] KechiZhang, ZhuoLi, JiaLi, GeLi, andZhiJin. Self-edit: Fault-awarecodeeditorforcodegeneration.
Annual Meeting of the Association for Computational Linguistics , 2023.
...
[1314] Ruichen Zhang, Mufan Qiu, Zhen Tan, Mohan Zhang, Vincent Lu, Jie Peng, Kaidi Xu, Leandro Z.
...
2025.
[1332] Zheng Zhang, Liang Ding, Dazhao Cheng, Xuebo Liu, Min Zhang, and Dacheng Tao. Bliss:
...
[1339] Penghao Zhao, Hailin Zhang, Qinhan Yu, Zhengren Wang, Yunteng Geng, Fangcheng Fu, Ling Yang,
...
[1340] PengyuZhao, ZijianJin, andNingCheng. Anin-depthsurveyoflargelanguagemodel-basedartificial
...
reasoningviallm-generatedinferencepathsoverknowledgegraphs,arXivpreprintarXiv:2502.12029,
...
grapheuleriantransformer, arXivpreprintarXiv:2401.00529v3, 2023. URL https://arxiv.org/
abs/2401.00529v3 .
[1344] Ruilin Zhao, Feng Zhao, Long Wang, Xianzhi Wang, and Guandong Xu. Kg-cot: Chain-of-thought
promptingoflargelanguagemodelsoverknowledgegraphsforknowledge-awarequestionanswering.
International Joint Conference on Artificial Intelligence , 2024.
...
[1352] Chuanyang Zheng, Yihang Gao, Han Shi, Minbin Huang, Jingyao Li, Jing Xiong, Xiaozhe Ren,
...
[1353] ChunmoZheng,SaikaWong,XingSu,YinqiuTang,AhsanNawaz,andMohamadKassem. Automating
...
[1357] Longtao Zheng, Rundong Wang, Xinrun Wang, and Bo An. Synapse: Trajectory-as-exemplar
...
[1365] Bin Zhou, Xingwang Shen, Yuqian Lu, Xinyu Li, B. Hua, Tianyuan Liu, and Jinsong Bao. Semantic-
awareeventlinkreasoningoverindustrialknowledgegraphembeddingtimeseriesdata. International
...
imperfectteachermodelsinlow-budgetscenarios. AnnualMeetingoftheAssociationforComputational
Linguistics , 2024.
...
[1376] AndrewZhu,LiamDugan,andChristopherCallison-Burch. Redel: Atoolkitforllm-poweredrecursive
multi-agent systems. Conference on Empirical Methods in Natural Language Processing , 2024.
163

[1377] Dawei Zhu, Nan Yang, Liang Wang, Yifan Song, Wenhao Wu, Furu Wei, and Sujian Li. Pose: Efficient
...
URLhttps://arxiv.org/abs/2506.11102v1 .
...
[1383] RongzhiZhu, XiangyuLiu, ZequnSun, YiweiWang, andWeiHu. Mitigatinglost-in-retrievalproblems
